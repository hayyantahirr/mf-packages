          ...
          >
            ...
            <div className="p-8 md:p-10">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link
                  href="/contact"
                  className={`inline-flex items-center justify-center gap-2 py-3.5 rounded-2xl font-black text-xs uppercase tracking-[0.15em] transition-all duration-300 hover:-translate-y-0.5 ${method.ctaColor}`}
                >
                  Request Quote
                  <ArrowRight size={13} />
                </Link>
                <button
                  ...
                  className={`inline-flex items-center justify-center gap-2 py-3.5 rounded-2xl font-black text-xs uppercase tracking-[0.15em] transition-all duration-300 hover:-translate-y-0.5 border-2 ${method.borderColor} ${method.accentColor} hover:${method.bgAccent} bg-transparent`}
                >
                  <Images size={13} />
                  See Samples
                </button>
