        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="space-y-6 animate-fade-in text-center lg:text-left">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight">
              ...
              <span className="bg-linear-to-r from-[#D00000] to-red-600 bg-clip-text text-transparent">
                Defining the Future.
              </span>
            </h1>
          ...
          <div className="relative group overflow-hidden rounded-2xl border border-white/10 shadow-xl max-w-md mx-auto lg:ml-auto lg:mr-0">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-linear-to-t from-[#1D2D44] via-transparent to-transparent opacity-40" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="group relative p-8 rounded-3xl bg-white/3 border border-white/10 hover:border-[#D00000]/40 transition-all duration-500 hover:-translate-y-2"
              >
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-[#D00000] uppercase tracking-tighter mt-1">
                      {stat.label}
                    </p>
                  </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="flex gap-4">
                <div className="shrink-0 w-12 h-12 rounded-xl bg-[#D00000]/20 flex items-center justify-center">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div className="p-6 rounded-2xl bg-white/3 border border-white/10 hover:border-[#D00000]/30 hover:bg-[#D00000]/5 transition-all group">
                ...
                <div className="p-6 rounded-2xl bg-white/3 border border-white/10 hover:border-blue-500/30 hover:bg-blue-500/5 transition-all group">
            ...
            <div className="relative group lg:justify-self-end mt-5 lg:mt-0 w-full max-w-lg">
              ...
              <div className="relative overflow-hidden rounded-[2.5rem] shadow-3xl bg-slate-900 transform group-hover:-translate-y-2 transition-transform duration-700">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-[#1D2D44] via-transparent to-transparent opacity-50 pointer-events-none" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 text-center">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact">
              <button className="px-8 py-3 bg-[#D00000] hover:bg-red-700 text-white font-bold rounded-xl transition-all hover:scale-105 shadow-lg shadow-red-500/20">
                Reach us Now !
              </button>
            </Link>
          </div>
